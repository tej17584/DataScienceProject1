...
#Resultado 1: "INED"
DATA3[which(DATA3$ESTABLECIMIENTO == "INED"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "INED"] <- "INSTITUTO NACIONAL DE EDUCACION DIVERSIFICADA"

#Resultado 2: "EORM"
DATA3[which(DATA3$ESTABLECIMIENTO == "EORM"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EORM"] <- "ESCUELA OFICIAL RURAL MIXTA"

#Resultado 3: "INEB"
DATA3[which(DATA3$ESTABLECIMIENTO == "INEB"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "INEB"] <- "INSTITUCION NACIONAL DE EDUCACION BASICA"

#Resultado 4: "EPRM"
DATA3[which(DATA3$ESTABLECIMIENTO == "EPRM"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EPRM"] <- "ESCUELA PRIVADA RURAL MIXTA"

#Resultado 5: "IEBC"
DATA3[which(DATA3$ESTABLECIMIENTO == "IEBC"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "IEBC"] <- "INSTITUTO DE EDUCACION BASICA COOPERATIVA"

#Resultado 6: "EODP"
DATA3[which(DATA3$ESTABLECIMIENTO == "EODP"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EODP"] <- "ESCUELA OFICIAL DE PARVULOS"

#Resultado 7: "EOUM"
DATA3[which(DATA3$ESTABLECIMIENTO == "EOUM"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EOUM"] <- "ESCUELA OFICIAL URBANA MIXTA"

#Resultado 8: "EOUN"
DATA3[which(DATA3$ESTABLECIMIENTO == "EOUN"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EOUN"] <- "ESCUELA OFICIAL URBANA DE NIÑAS"

#Resultado 9: "EOPA"
DATA3[which(DATA3$ESTABLECIMIENTO == "EOPA"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EOPA"] <- "ESCUELA OFICIAL PARA ADULTOS"

#Resultado 10: "EOUV"
DATA3[which(DATA3$ESTABLECIMIENTO == "EOUV"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EOUV"] <- "ESCUELA OFICIAL URBANA DE VARONES"

#Resultado 11: "COPB"
DATA3[which(DATA3$ESTABLECIMIENTO == "COPB"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "COPB"] <- "CENTRO OFICIAL DE PREPRIMARIA BILINGUE"

#Resultado 12: "EORN"
DATA3[which(DATA3$ESTABLECIMIENTO == "EORN"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EORN"] <- "ESCUELA OFICIAL RURAL DE NIÑAS"

#Resultado 13: "EMRM"
DATA3[which(DATA3$ESTABLECIMIENTO == "EMRM"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EMRM"] <- "ESCUELA MUNICIPAL RURAL MIXTA"

#Resultado 14: "IEEB"
DATA3[which(DATA3$ESTABLECIMIENTO == "IEEB"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "IEEB"] <- "INSTITUTO EXPERIMENTAL DE EDUCACION BASICA"

#Resultado 15: "EMUM"
DATA3[which(DATA3$ESTABLECIMIENTO == "EMUM"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EMUM"] <- "ESCUELA MUNICIPAL URBANA MIXTA"

#Resultado 16: "EORV"
DATA3[which(DATA3$ESTABLECIMIENTO == "EORV"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "EORV"] <- "ESCUELA MUNICIPAL URBANA MIXTA"

#Resultado 17: "ERMP"
DATA3[which(DATA3$ESTABLECIMIENTO == "ERMP"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "ERMP"] <- "ESCUELA RURAL MIXTA DE PARVULOS"

#Resultado 17: "ERMP"
DATA3[which(DATA3$ESTABLECIMIENTO == "ERMP"),]
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "ERMP"] <- "ESCUELA RURAL MIXTA DE PARVULOS"

DATA3$ESTABLECIMIENTO <- ifelse(grepl("ERMP", DATA3$ESTABLECIMIENTO), "ESCUELA RURAL MIXTA DE PARVULOS", )
...
# use this index vector to extract the rows you want from the data frome:
selected_rows = DATA3[ndx,]

#las filas a cambiar son la 9 y 467
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == '"LICEO LA SALLE"'] <- "LICEO LA SALLE"
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == '"LICEO EDUCACIONAL MIXTO DEI VERBUM"'] <- "LICEO EDUCACIONAL MIXTO DEI VERBUM"
...
ptn2 = '^INST. .*?'  # gets beige and berry but not blueberry
# execute a pattern-matching function on your data to create an index vector
ndx2 = grep(ptn2, DATA3$ESTABLECIMIENTO, perl=T)
# use this index vector to extract the rows you want from the data frome:
selected_rows2 = DATA3[ndx2,]

#las filas a cambiar son la 73
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "INST. PRIV. MIXTO DE EDUC. DIVERSIFICADA ESCUELA DE CIENCIAS COMERCIALES"] <- 
  "INSTITUTO PRIVADO MIXTO DE EDUCACION DIVERSIFICADA ESCUELA DE CIENCIAS COMERCIALES"
...
ptn3 = "^'LICEO.*?"  # gets beige and berry but not blueberry
# execute a pattern-matching function on your data to create an index vector
ndx3 = grep(ptn3, DATA3$ESTABLECIMIENTO, perl=T)
# use this index vector to extract the rows you want from the data frome:
selected_rows3 = DATA3[ndx3,]

DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "'LICEO SAN JOSE'"] <- "LICEO SAN JOSE"
...
ptn4 = "^INED.*?"  # gets beige and berry but not blueberry
# execute a pattern-matching function on your data to create an index vector
ndx4 = grep(ptn4, DATA3$ESTABLECIMIENTO, perl=T)
# use this index vector to extract the rows you want from the data frome:
selected_rows4 = DATA3[ndx4,]

DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "INED PROF. HUGO LEONEL SANCE CETINO"] <- 
  "INSTITUTO NACIONAL DE EDUCACION DIVERSIFICADA PROF. HUGO LEONEL SANCE CETINO"
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "INED ADSCRITO AL INSTITUTO NACIONAL DE EDUCACION BASICA EXPERIMENTAL CON ORIENTACION OCUPACIONAL DR. LUIS PASTEUR"] <- 
  "INSTITUTO NACIONAL DE EDUCACION DIVERSIFICADA ADSCRITO AL INSTITUTO NACIONAL DE EDUCACION BASICA EXPERIMENTAL CON ORIENTACION OCUPACIONAL DR. LUIS PASTEUR"
DATA3$ESTABLECIMIENTO[DATA3$ESTABLECIMIENTO == "INED TECNICO MORALENSE, ITM"] <- 
  "INSTITUTO NACIONAL DE EDUCACION DIVERSIFICADA TECNICO MORALENSE, ITM"
...
##/--------------**--* FINALIZA LIMPIEZA ESPECÍFICA SUCHITEPEQUEZ, SACATEPEQUEZ, RETALHULEU, CHIMALTENANGO